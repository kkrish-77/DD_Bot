        ...
        if (isMessageRecent(timestamp)) {
          ...
          if (typeOfMsg === "text_message") {
            ...
            if (incomingMessage.text.body.toUpperCase() === "APML") {
              ...
              const res = await SafetyCheck.updateOne(
                { _id: docId },
                { gcnumber: gcNumber, status: "ewaynumbercomplete" }
              );
            ...
            if (flow) {
              ...
              if (flowMessage.flow_token === "flows-builder-e9e7a79a") {
              ...
              } else if (flowMessage.flow_token === "flows-builder-4d1dda82") {
            ...
            if (sessionType === "voiceNote") {
              ...
              if (session.get(recipientPhone).partyname === "canonIndia") {
            ...
            if (buttonId === "newvehicle") {
              ...
              await sendFlow({
                ...
                flow_id: "1428642731370424",
                flow_token: "flows-builder-e9e7a79a",
                recipientPhone,
              });
              ...
              await sendFlow({
                ...
                flow_id: "1467812577476722",
                flow_token: "flows-builder-4d1dda82",
                recipientPhone,
              });
...
// (async () => {
//   const checkList = await SafetyCheck.find({});

//   if (Array.isArray(checkList) && checkList.length > 0) {
//     const obj = {};

//     checkList.forEach((check) => {
//       const object = Object.entries(check);
